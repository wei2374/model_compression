...
import numpy as np
from pruning.helper_functions import get_block_result
...
def get_and_plot_taylor1(model, layer_index_dic, dataset="food101", PLOT=False):
    train_data, _ = get_data_from_dataset(dataset, batch_size=4, small_part=1)
    batches_n = 20
    activation_layers = {}
    c = 0
